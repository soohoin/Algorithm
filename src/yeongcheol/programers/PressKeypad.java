...
public class PressKeypad {
    ...
    */
    ...
    public String solution(int[] numbers, String hand) {
        ...
        int leftMinusRight  = 0;                                // 왼손거리 - 오른손거리
        ...
        for(int target : numbers) {
            ...
            if(isEasyChoice(target,targetList)) {              // 경쟁영역의 숫자가 아닌 경우
                ...
                leftMinusRight   = getDistance(leftLocation,targetTemp) - getDistance(rightLocation,targetTemp);
                pressHardChoice(leftMinusRight,targetTemp,defaultHand,result);  // 경쟁영역의 숫자 버튼클릭 수행
            }   
        }
